...
def check_stock():
    try:
        ...
        # Add to Cart 버튼이 있으면 재고 있음
        add_to_cart = soup.select_one("button.add-to-cart")  # 알리 영어 페이지 기준
